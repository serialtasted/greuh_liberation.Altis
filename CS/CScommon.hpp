...
class CS_RscControlsGroupNoScrollbars : CS_RscControlsGroup {
...
class CS_RscPictureKeepAspect : CS_RscPicture {
	style = 0x30 + 0x800;
};

class CS_RscStructuredText {
	type = 13;
	style = 0;
	x = 0;
	y = 0;
...
class CS_RscButtonTextOnly : CS_RscButton {
	SizeEx = "(			(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)";
...
class CS_RscButtonMenu : CS_RscShortcutButton 
{
	idc = -1;
	type = 16;
	style = "0x02 + 0xC0";
...
class CS_RscShortcutButtonMain : CS_RscShortcutButton {
	idc = -1;
	style = 0;
	default = 0;
	w = 0.313726;
...
class CS_RscListBox 
{
	...
	class ListScrollBar: CS_ScrollBar
	{
		color[] = {1,1,1,1};
		autoScrollEnabled = 1;
	};
...
class CS_RscBackground : CS_RscText {
	type = 0;
	IDC = -1;
	style = 512;
	shadow = 0;
