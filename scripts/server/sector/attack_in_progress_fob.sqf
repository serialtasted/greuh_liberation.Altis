...
if ( GRLIB_blufor_defenders ) then {
	...
	[_thispos, GRLIB_side_friendly, 15, [true,false], [true,false,_useair], false, [3,_force], [0, floor(_force/2)], "default", nil, "this addMPEventHandler ['MPKilled', {_this spawn kill_manager}]", 1] spawn F_LVmilitarize;
};
