...
blufor_pilot createUnit [ _pilotsPos, _pilotsGrp,"this addMPEventHandler [""MPKilled"", {_this spawn kill_manager}]", 0.5, "private"];
sleep 0.2;
blufor_pilot createUnit [ _pilotsPos getpos [ 1, random 360 ], _pilotsGrp,"this addMPEventHandler [""MPKilled"", {_this spawn kill_manager}]", 0.5, "private"];
sleep 2;
...
for [ {_idx=0},{_idx < _nbsentry},{_idx=_idx+1} ] do {
	opfor_sentry createUnit [ [ _pilotsPos, 1, random 360 ], _grpsentry,"this addMPEventHandler [""MPKilled"", {_this spawn kill_manager}]", 0.5, "private"];
};
