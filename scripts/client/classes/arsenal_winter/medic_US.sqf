...
if ( classtogo != "" ) then {
	...
	player addVest "pmf_Vest_dpm_ranger";
	...
	player addBackpack "pmf_kitbag_dpm_medic";
...
baseVest = "pmf_Vest_dpm_ranger";
baseHeadGear = "pmf_dpm_ech_a";
baseBackpack = "pmf_kitbag_dpm_medic";
...
arsenal_backpacks = [
	// vanilla backpacks
	"pmf_compact_medic_dpm",
	"pmf_kitbag_dpm_medic",
